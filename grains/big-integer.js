var bigInt = (function(e) {
  ...
  function f(e) {
    return e < 1e7
      ? [e]
      : e < 1e14 ? [e % 1e7, Math.floor(e / 1e7)] : [e % 1e7, Math.floor(e / 1e7) % 1e7, Math.floor(e / 1e14)];
  }
  function l(e) {
    c(e);
    var n = e.length;
  ...
  function y(e, t, n) {
    var r, i;
    return A(e, t) >= 0 ? (r = g(e, t)) : ((r = g(t, e)), (n = !n)), (r = l(r)), typeof r == 'number'
      ? (n && (r = -r), new u(r))
      : new o(r, n);
  }
  function b(e, n, r) {
  ...
  function N(e, n) {
    ...
    for (d = r - i; d >= 0; d--) {
      ...
      for (g = 0; g < y; g++)
        (v += p * c[g]), (b = Math.floor(v / s)), (m += f[d + g] - (v - b * s)), (v = b), m < 0
          ? ((f[d + g] = m + s), (m = -1))
          : ((f[d + g] = m), (m = 0));
      while (m !== 0) {
        (p -= 1), (v = 0);
  ...
  function C(e, n) {
    ...
    while (r) {
      ...
      (f = o.length), (c = o[f - 1] * u + o[f - 2]), (h = n[i - 1] * u + n[i - 2]), f > i &&
        (c = (c + 1) * u), (a = Math.ceil(c / h));
      do {
        p = E(n, a);
        if (A(p, o) <= 0) break;
        a--;
  ...
  function L(e, n) {
    ...
    if (i.isSmall) {
      ...
      if (h < t) {
        (r = k(s, h)), (c = l(r[0]));
        var d = r[1];
        return e.sign && (d = -d), typeof c == 'number'
    ...
    var m = e.sign !== i.sign,
      g = r[1],
      y = e.sign;
    return typeof c == 'number' ? (m && (c = -c), (c = new u(c))) : (c = new o(c, m)), typeof g == 'number'
      ? (y && (g = -g), (g = new u(g)))
      : (g = new o(g, y)), [c, g];
  }
  function A(e, t) {
  ...
  function D(e) {
    return (
      ((typeof e == 'number' || typeof e == 'string') && +Math.abs(e) <= t) || (e instanceof o && e.value.length <= 1)
    );
  }
  function P(e, t, n) {
    t = z(t);
    ...
    while (!f || !l)
      s.isZero()
        ? ((f = !0), u.push(r ? 1 : 0))
        : r ? u.push(s.isEven() ? 1 : 0) : u.push(s.isEven() ? 0 : 1), o.isZero()
        ? ((l = !0), a.push(i ? 1 : 0))
        : i ? a.push(o.isEven() ? 1 : 0) : a.push(o.isEven() ? 0 : 1), (s = s.over(2)), (o = o.over(2));
    var c = [];
  ...
  function j(e, t) {
    return (e = z(e).abs()), (t = z(t).abs()), e.equals(t)
      ? e
      : e.isZero()
        ? t
        : t.isZero()
          ? e
          : e.isEven()
            ? t.isOdd() ? j(e.divide(2), t) : j(e.divide(2), t.divide(2)).multiply(2)
            : t.isEven()
              ? j(e, t.divide(2))
              : e.greater(t) ? j(e.subtract(t).divide(2), t) : j(t.subtract(e).divide(2), e);
  }
  function F(e, t) {
  ...
  function R(e) {
    var t = e.value;
    return typeof t == 'number' && (t = [t]), t.length === 1 && t[0] <= 36
  ...
  (o.prototype.add = function(e) {
    ...
    return L(this, e)[1];
  }), (u.prototype.remainder = u.prototype.mod = o.prototype.remainder = o.prototype.mod), (o.prototype.pow = function(
    e,
  ) {
    var t = z(e),
      n = this.value,
  ...
  }), (u.prototype.eq = u.prototype.equals = o.prototype.eq = o.prototype.equals), (o.prototype.notEquals = function(
    e,
  ) {
    return this.compare(e) !== 0;
  }), (u.prototype.neq = u.prototype.notEquals = o.prototype.neq =
    o.prototype.notEquals), (o.prototype.greater = function(e) {
    return this.compare(e) > 0;
  }), (u.prototype.gt = u.prototype.greater = o.prototype.gt = o.prototype.greater), (o.prototype.lesser = function(e) {
    return this.compare(e) < 0;
  }), (u.prototype.lt = u.prototype.lesser = o.prototype.lt =
    o.prototype.lesser), (o.prototype.greaterOrEquals = function(e) {
    return this.compare(e) >= 0;
  }), (u.prototype.geq = u.prototype.greaterOrEquals = o.prototype.geq =
    o.prototype.greaterOrEquals), (o.prototype.lesserOrEquals = function(e) {
    return this.compare(e) <= 0;
  }), (u.prototype.leq = u.prototype.lesserOrEquals = o.prototype.leq =
    o.prototype.lesserOrEquals), (o.prototype.isEven = function() {
  ...
  (o.prototype.shiftLeft = function(e) {
    ...
    if (!D(e))
      return e.isNegative()
        ...
        : ((t = this.divmod(W[2].pow(e))), t.remainder.isNegative() ? t.quotient.prev() : t.quotient);
    e = +e;
  ...
  return (W.one = W[1]), (W.zero = W[0]), (W.minusOne =
    W[-1]), (W.max = H), (W.min = B), (W.gcd = j), (W.lcm = F), (W.isInstance = function(e) {
